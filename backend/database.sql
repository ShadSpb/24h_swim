...
CREATE TABLE "teams"('team_id' INTEGER UNIQUE NOT NULL, 'team_name' TEXT NOT NULL, PRIMARY KEY(team_name));
...
CREATE TABLE "users"('email' TEXT NOT NULL, 'password' TEXT NOT NULL, 'person_id' TEXT NOT NULL, 'last_logon_time' TEXT NOT NULL, 'disabled' INTEGER NOT NULL DEFAULT 0, 
FOREIGN KEY(person_id) REFERENCES persons(person_id),
PRIMARY KEY(email)
);
...
INSERT INTO users VALUES ('user1@domain.com', 'StrongPassword','uuid1f99f020-ace1-4b1e-82d1-f728f6098f1d', CURRENT_TIMESTAMP, 0);
INSERT INTO users VALUES ('user2@domain1.com', 'StrongPassword','fbbab0b2-0064-4702-9777-73422c6884eb', CURRENT_TIMESTAMP, 0);
INSERT INTO users VALUES ('user3@domain.com', 'StrongPassword','b2d7bb69-35b9-4b7d-8add-685223d51843', CURRENT_TIMESTAMP, 0);
INSERT INTO users VALUES ('user4@domain.com', 'StrongPassword','0fd7ee79-6358-47fd-af92-aa5d49808e77', CURRENT_TIMESTAMP, 0);
INSERT INTO users VALUES ('user5@domain.com', 'StrongPassword','54477a13-9362-4bf9-b77c-ce98401a1c5d', CURRENT_TIMESTAMP, 0);
INSERT INTO users VALUES ('user6@domain.com', 'StrongPassword','9bc8fec6-5a36-4355-bb67-8f80c1f9be5c', CURRENT_TIMESTAMP, 0);