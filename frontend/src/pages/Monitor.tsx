...
export default function Monitor() {
  ...
  // Registered swimmers per team, derived from the (already loaded) swimmer
  // stats — which include every registered swimmer, even those with 0 laps.
  const swimmersPerTeam = useMemo(() => {
